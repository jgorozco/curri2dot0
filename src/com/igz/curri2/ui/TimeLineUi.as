package com.igz.curri2.ui 
{
	...
	public class TimeLineUi extends Sprite
	{
		...
		for (inn = 0; inn < _LocalProyects.length; inn++)
		{
			//TODO pintar las lineas de los proyectos 
			actualp = (_LocalProyects[inn] as ProyectDto);
			if (actualp.InitDate < _InitialDate)
			{
				_InitialDate = actualp.InitDate;
			}
		}
